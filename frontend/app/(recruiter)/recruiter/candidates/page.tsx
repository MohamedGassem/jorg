...
export default function CandidatesPage() {
  ...
  function handleFilterChange(key: keyof typeof EMPTY_FILTERS, value: string | null) {
    value = value ?? "";
        ...
        <CardContent className="pt-4">
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            ...
            <div className="space-y-1">
              ...
              <Input type="number" placeholder="ex: 800" value={filters.max_daily_rate} onChange={(e) => handleFilterChange("max_daily_rate", e.target.value)} />
            </div>
            <div className="space-y-1">
              <Label>Compétence</Label>
              <Input placeholder="ex: Python" value={filters.skill} onChange={(e) => handleFilterChange("skill", e.target.value)} />
            </div>
            <div className="space-y-1">
              <Label>Localisation</Label>
              <Input placeholder="ex: Paris" value={filters.location} onChange={(e) => handleFilterChange("location", e.target.value)} />
            </div>
            <div className="space-y-1">
              <Label>Domaine</Label>
            ...
            <div className="space-y-1">
              ...
              <Input placeholder="titre, résumé…" value={filters.q} onChange={(e) => handleFilterChange("q", e.target.value)} />
            </div>
          </div>
